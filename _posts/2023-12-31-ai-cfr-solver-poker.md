...
The most well-known algorithm is called **_CFR – counterfactual regret minimization_**. In fact, my entire process of studying Poker is one big algorithm. I used to play 10k hands, take it to my coach, get it reviewed against "correct" strategy and try to play more optimal next time. My whole studying process was to minimize regret in a way. 
